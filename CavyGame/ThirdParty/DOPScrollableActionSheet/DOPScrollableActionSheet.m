...
- (instancetype)initWithActionArray:(NSArray *)actions {
    ...
    if (self) {
        ...
        _cancel.frame = CGRectMake(0, y, _screenRect.size.width, 60);
        [_cancel setTitle:NSLocalizedString(@"Cancel", @"cancel button name") forState:UIControlStateNormal];
        [_cancel setTitleColor:[UIColor purpleColor] forState:UIControlStateNormal];
