...
+ (void)addShadowWithColor:(UIColor *)color1 color2:(UIColor *)color2 inImageView:(UIImageView *)imageView
{
    [self addGradientLayer:imageView color1:color1 color2:color2];
}
...
+ (void)addGradientLayer:(UIImageView *)imageView color1:(UIColor *)color1 color2:(UIColor *)color2
{
    CAGradientLayer *gradientLayer = [CAGradientLayer layer];
    gradientLayer.frame = imageView.layer.bounds;
    
    CGFloat hue, saturation, brightness;
    [color1 getHue:&hue saturation:&saturation brightness:&brightness alpha:nil];
